...
<form action="#" class="mt-4" @submit.prevent="edit ? updateContact(contact.id) : createContact()">
...
<hr>
    ...
    <ul class="list-group">
        ...
        <button @click="showContact(contact.id)" class="btn btn-success btn-sm">Edit</button>
